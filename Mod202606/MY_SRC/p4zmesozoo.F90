...
CONTAINS
   ...
   SUBROUTINE p4z_mesozoo( kt, knt )
      ...
      REAL(wp), POINTER, DIMENSION(:,:,:) ::  zz_Excr_mesozoo_3D, zz_NatMort_mesozoo_3D  
      ...
      CALL wrk_alloc( jpi, jpj, jpk, zz_Excr_mesozoo_3D, zz_NatMort_mesozoo_3D )
      ...
      DO jk = 1, jpkm1
         DO jj = 1, jpj
            DO ji = 1, jpi
                ...
                zz_NatMort_mesozoo_3D(ji,jj,jk) = zz_NatMort_mesozoo
                zz_Excr_mesozoo_3D(ji,jj,jk) = zz_Excr_mesozoo
      ...
      CALL iom_put("Z2_EXCR", zz_Excr_mesozoo_3D)
      CALL iom_put("Z2_NATMORT", zz_NatMort_mesozoo_3D)
      ...
      IF( l_trdtrc ) THEN
         ...
         END DO
         IF( iom_use("O2MSZ")) THEN
            CALL iom_put("O2MSZ",tra(:,:,:,jpo2)-ztrtra(:,:,:,jpo2))
         ENDIF
      ...
      CALL wrk_dealloc( jpi, jpj, jpk, zz_Excr_mesozoo_3D, zz_NatMort_mesozoo_3D )
      !
