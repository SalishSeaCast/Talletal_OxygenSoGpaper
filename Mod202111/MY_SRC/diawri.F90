...
# if defined key_iomput
   ...
   SUBROUTINE dia_wri( kt )
      ...
      CALL iom_put( "rhop", rhop(:, :, :) - 1000._wp * tmask(:, :, :))        ! sigma theta
      CALL iom_put("bfN2", rn2(:, :, :))           ! buoyancy frequency
