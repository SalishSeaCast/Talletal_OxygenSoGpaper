...
902   IF( ios /= 0 ) CALL ctl_nam ( ios , 'namzdf_gls in configuration namelist', lwp )
      ...
      rsbc_zs2  = rn_frac_hs / grav * 665._wp                            ! Rascle formula for surface roughness (BMM: removed 0.85)
